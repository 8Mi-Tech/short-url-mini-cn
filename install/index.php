...
<div class="panel panel-primary">
	<div class="panel-heading" style="background: #15A638;">
		<h3 class="panel-title" align="center">短网址生成程序(天天修改)</h3>
	</div>
	<div class="panel-body">
		<p><iframe src="./install.txt" style="width:100%;height:465px;"></iframe></p>
		<?php if($installed){ ?>
		<div class="alert alert-warning">您已经安装过，如需重新安装请删除<font color=red>install.lock </font>文件后再安装！>><a href="../">网站首页</a></div>
		<?php }else{?>
	...
	if(!$dbconfig['user']||!$dbconfig['pwd']||!$dbconfig['dbname']) {
		...
		if(!$con=DB::connect($dbconfig['host'],$dbconfig['user'],$dbconfig['pwd'],$dbconfig['dbname'],$dbconfig['port'])){
			...
			if(DB::query("select * from ".$dbconfig['dbqz']."_config where 1")==FALSE)
				...
				echo '<div class="list-group-item list-group-item-info">系统检测到你已安装过天天娱乐代刷系统</div>
...
<div class="progress progress-striped">
  <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%">
	...
	<div class="panel-body">
<?php
	@file_put_contents("../install.lock",'程序验证文件');
	clearpack();
	echo '<div class="alert alert-info"><font color="green">安装完成！</br> 你可以正常使用本程序了！</br>为了防止黑客攻击，请删除根目录下的install文件夹</font><br/><br/><a href="../">>>前往网站首页</a><hr/><br/><br/><font color="#FF0033">如果你的空间不支持本地文件读写，<br/>请自行在根目录建立 install.lock 文件！<br/>本程序无木马无盗链，请放心使用！</font></div>';
?>
	</div>
</div>
